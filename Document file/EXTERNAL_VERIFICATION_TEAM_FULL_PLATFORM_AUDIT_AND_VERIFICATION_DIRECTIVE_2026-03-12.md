# EXTERNAL VERIFICATION TEAM — FULL PLATFORM AUDIT & VERIFICATION DIRECTIVE — 2026-03-12

## التوجيه الرسمي الشامل المخصص لأي فريق تحقق خارجي

**Project:** Medical Devices Intelligent Scientific Knowledge Platform  
**Repository:** `https://github.com/mosathawabamosa2020-rgb/MedicalBot/commits?author=mosathawabamosa2020-rgb`  
**Issued By:** Founder / Technical Architecture Authority  
**Audience:** External Verification Team  
...
## 1. Mission of This Verification Assignment
...
Before beginning execution, you must:
1. Review the repository thoroughly.
2. Review the provided project documentation package thoroughly.
3. Understand what the development team was instructed to build, harden, verify, and prove.
4. Determine what is actually implemented, what is partially implemented, what is blocked, and what is only claimed in documentation.
...
## 2. Governing Documentation You Must Review First
...
11. this file: `EXTERNAL_VERIFICATION_TEAM_FULL_PLATFORM_AUDIT_AND_VERIFICATION_DIRECTIVE_2026-03-12.md`
12. the matching report template: `EXTERNAL_VERIFICATION_TEAM_FULL_PLATFORM_AUDIT_REPORT_TEMPLATE.md`

If implementation reality conflicts with documents, you must report the contradiction explicitly.

---

## 3. Primary Verification Questions You Must Answer
...
## 4. Mandatory Repository Review Scope
...
## 5. Mandatory Verification Scope

## 5.1 Database and Schema Verification
...
## 5.2 Core Backbone and Operational Stability
You must verify:
- `npx prisma generate`
...
## 5.3 Authentication and Access Control Verification
...
## 5.4 UI / UX / Design / Page Flow Verification
...
## 5.5 Service Verification Against the Database
...
## 5.6 Smart Discovery / Search / Retrieval Live Proof
This is mandatory.
...
## 5.7 Source Expansion Candidate Review
...
## 5.8 End-to-End Knowledge Flow Verification
...
## 7. Required Structure of the Main Verification Report

The file `docs/02-validation/EXTERNAL_VERIFICATION_TEAM_FULL_PLATFORM_AUDIT_AND_VERIFICATION_REPORT.md` must include these sections in this exact order:
...
## 8. Required Founder Questions Section
